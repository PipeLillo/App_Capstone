...
describe('ProfilePage', () => {
  ...
  // -----------------------------------------------------------------
  // --- 1. PRUEBAS DE VALOR (LÓGICA DE DATOS Y FORMULARIO) ---
  // -----------------------------------------------------------------
  describe('✅ Pruebas de Valor (Lógica de Datos y Formulario)', () => {
  ...
  // -----------------------------------------------------------------
  // --- 2. PRUEBAS GENÉRICAS (INTEGRACIÓN Y ERRORES) ---
  // -----------------------------------------------------------------
  describe('⚙️ Pruebas Genéricas (Integración y Errores)', () => {
