...
export class LoginPage implements OnInit {
  ...
  async signInWithGoogle() {
    ...
    try {
      ...
      await this.saveUserToDatabase(user.uid, user.email, user.displayName, user.photoURL);
  ...
  private async saveUserToDatabase(uid: string, email: string | null, displayName: string | null, photoURL: string | null) {
    try {
