...
export class AuthenticationService {
  ...
  private azureBaseUrl = environment.AZURE_BASE_URL || '';

  private azureSaveUrl      = `${this.azureBaseUrl}savetosql`;
  private azureUpdateUrl    = `${this.azureBaseUrl}updateuserinfo`;
  private azureGetUrl       = `${this.azureBaseUrl}getuserinfo`;
  private azureDeleteDoseUrl= `${this.azureBaseUrl}deletedose`;

  // --- Keys de Azure Functions (tomadas desde environment.ts) ---
  private azureSaveKey      = environment.AZURE_SAVE_KEY || '';
  private azureUpdateKey    = environment.AZURE_UPDATE_KEY || '';
  private azureGetKey       = environment.AZURE_GET_KEY || '';
  private azureDeleteDoseKey= environment.AZURE_DELETE_DOSE_KEY || '';
